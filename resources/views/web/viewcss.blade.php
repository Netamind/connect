...
.grid-col-column-right-1-5 {
    width: 100%;
    margin-bottom: 30px
}

.grid-col-column-right-1-5 .grid-items {
    justify-content: flex-start
}

.grid-item-column-right-1-5-1 {
    width: 100%
}
...
.module-blog_categories-42 .title.module-title {
    font-family: 'Montserrat';
    font-weight: 600;
    font-size: 17px;
    margin-bottom: 15px;
...
.module-blog_categories-42 .title.module-title::after {
    content: '';
    display: block;
    position: relative;
    margin-top: 10px
...
.module-blog_categories-42 .title.module-title.page-title>span::after {
    content: '';
    display: block;
    position: relative;
    margin-top: 10px
...
.module-blog_categories-42 a:hover span {
    color: rgba(233, 102, 49, 1)
}
...
.module-blog_comments-47 img {
    margin-right: 7px;
    border-radius: 50%
}

.module-blog_comments-47 .module-item {
    padding-top: 8px;
    margin-bottom: 8px
}

.module-blog_comments-47 .side-title {
    line-height: 1.2
}

.module-blog_comments-47 .module-body>div+div {
    border-style: solid;
    border-color: rgba(226, 226, 226, 1)
}

.module-blog_comments-47 .side-details {
    white-space: normal;
    overflow: visible;
    text-overflow: initial
}
...
.module-gallery-176 .module-item>a {
    border-radius: 7px
}
...
.desktop .lg-176 .lg-actions .lg-prev:hover::before {
    color: rgba(233, 102, 49, 1)
}
...
.desktop .lg-176 .lg-actions .lg-next:hover::before {
    color: rgba(233, 102, 49, 1)
}
...
.lg-176 div.lg-thumb-item.active img {
    border-color: rgba(233, 102, 49, 1)
}
