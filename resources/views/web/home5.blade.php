...
<div id="welcomeLine" class="row">
	...
	<div class="span12">
		...
		<a href="#" style="float:left"><span class="">Terms and conditions</span></a>
    
        
		<a href="#" style="float:right;margin-right:10px"><span class="">FAQ</span></a> 

        <a href="#" style="float:right;margin-right:10px"><span class=""></span> |</a> 
...
<!-- Footer ================================================================== -->
	<div  id="footerSection" style="padding-left:10px;padding-right:10px
   ">
	<div class="container">
		<div class="row">
			<div class="span3">
        ...
        <div class="text-center" style="padding-bottom:-50px">
			<a href="#" style="text-align:center;padding-top:15px;padding-bottom:0px">2024 @ Connect All Right Reserved</a>
			<span></span>
        </div>
