...
<meta content="Codescandy" name="author">
      ...
      <link href="theme/assets/libs/tiny-slider/dist/tiny-slider.css" rel="stylesheet" />
      <link href="theme/assets/libs/slick-carousel/slick/slick.css" rel="stylesheet" />
      <link href="theme/assets/libs/slick-carousel/slick/slick-theme.css" rel="stylesheet" />



<!-- Libs CSS -->
<link href="theme/assets/libs/bootstrap-icons/font/bootstrap-icons.min.css" rel="stylesheet">
<link href="theme/assets/libs/feather-webfont/dist/feather-icons.css" rel="stylesheet">
	...
	<div class="container">
		...
		<div class="row align-items-center pt-6 pb-4 mt-4 mt-lg-0">
			<div class="col-xl-2 col-md-3 mb-4 mb-md-0 col-12 text-center text-md-start">
				<a href="https://freshcart.codescandy.com/index.html"><img src="https://freshcart.codescandy.com/assets/images/logo/freshcart-logo.svg" alt="eCommerce HTML Template" /></a>
			</div>
	...
	<div class="container">
		<div class="offcanvas offcanvas-start" tabindex="-1" id="navbar-default" aria-labelledby="navbar-defaultLabel">
			<div class="offcanvas-header pb-1">
				<a href="index.html"><img src="https://freshcart.codescandy.com/assets/images/logo/freshcart-logo.svg" alt="eCommerce HTML Template" /></a>
				...
				<div>
					<ul class="navbar-nav align-items-center">
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu">
								<li><a class="dropdown-item" href="https://freshcart.codescandy.com/index.html">Home 1</a></li>
						...
						<li class="nav-item">
							<a class="nav-link" href="https://freshcart.codescandy.com/dashboard/index.html">Dashboard</a>
						</li>
			...
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item py-3 ps-0">
					...
					<div class="row align-items-center">
						<div class="col-6 col-md-6 col-lg-7">
							<div class="d-flex">
								<img src="theme/assets/images/products/product-img-2.jpg" alt="Ecommerce" class="icon-shape icon-xxl" />
								<div class="ms-3">
									<a href="shop-single.html" class="text-inherit">
				...
				<li class="list-group-item py-3 ps-0">
					...
					<div class="row align-items-center">
						<div class="col-6 col-md-6 col-lg-7">
							<div class="d-flex">
								<img src="theme/assets/images/products/product-img-3.jpg" alt="Ecommerce" class="icon-shape icon-xxl" />
								<div class="ms-3">
									<!-- title -->
									<a href="shop-single.html" class="text-inherit">
				...
				<li class="list-group-item py-3 ps-0">
					...
					<div class="row align-items-center">
						<div class="col-6 col-md-6 col-lg-7">
							<div class="d-flex">
								<img src="theme/assets/images/products/product-img-4.jpg" alt="Ecommerce" class="icon-shape icon-xxl" />
								<div class="ms-3">
									<!-- title -->
									<!-- title -->
									<a href="shop-single.html" class="text-inherit">
				...
				<li class="list-group-item py-3 ps-0 border-bottom">
					...
					<div class="row align-items-center">
						<div class="col-6 col-md-6 col-lg-7">
							<div class="d-flex">
								<img src="theme/assets/images/products/product-img-5.jpg" alt="Ecommerce" class="icon-shape icon-xxl" />
								<div class="ms-3">
									<!-- title -->
									<a href="shop-single.html" class="text-inherit">
         ...
         <section class="mt-8">
            <div class="container">
               <div class="hero-slider">
                  ...
                  <div style="background: url(theme/assets/images/slider/hero2.jpg) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
                     <div class="ps-lg-12 py-lg-16 col-xxl-5 col-lg-7 col-md-8 py-14 px-8 text-xs-center">
                        <h1 class="text-white display-5 fw-bold mt-4">Increase your brand visibility</h1>
                        <p class="lead text-white">Advertise your businesses with us.</p>
                 ...
                 <!-- <div style="background: url(theme/assets/images/slider/hero-img-slider-2.jpg) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
                     <div class="ps-lg-12 py-lg-16 col-xxl-5 col-lg-7 col-md-8 py-14 px-8 text-xs-center">
                  ...
                  <div style="background: url(theme/assets/images/slider/hero-img-slider-3.jpg) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
                     <div class="ps-lg-12 py-lg-16 col-xxl-5 col-lg-7 col-md-8 py-14 px-8 text-xs-center">
                        ...
                        <div class="product-slider-four-column">
                           ...
                           <div class="item">
                              ...
                              <div class="card card-product mb-4">
                                 <div class="card-body text-center py-8">
                                    <!-- img -->
                                    <a href="#"><img src="theme/assets/images/category/category-bakery-biscuits.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                    <!-- text -->
                                 </div>
                              </div>
                              <div>
                           ...
                           <div class="item">
                              ...
                              <div class="card card-product mb-4">
                                 <div class="card-body text-center py-8">
                                    <!-- img -->
                                    <a href="#"><img src="theme/assets/images/category/category-atta-rice-dal.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                    <!-- text -->
                                 </div>
                              </div>
                              <div>
                           ...
                           <div class="item">
                              ...
                              <div class="card card-product mb-4">
                                 <div class="card-body text-center py-8">
                                    <!-- img -->
                                    <a href="#"><img src="theme/assets/images/category/category-chicken-meat-fish.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                    <!-- text -->
                                 </div>
                              </div>
                              <div>
                           ...
                           <div class="item">
                              ...
                              <div class="card card-product mb-4">
                                 <div class="card-body text-center py-8">
                                    <!-- img -->
                                    <a href="#"><img src="theme/assets/images/category/category-cleaning-essentials.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                    <!-- text -->
                                 </div>
                              </div>
                              <div>
                        ...
                        <div class="card border border-danger p-6">
                           <div class="row">
                              <div class="col-lg-5 text-center">
                                 <a href="pages/shop-single.html"><img src="theme/assets/images/products/deal-img.jpg" alt="Grocery Ecommerce Template" class="img-fluid" /></a>
                              </div>
                              ...
                              <div class="col">
                                 <div class="mb-6">
                                    <div class="card card-product mb-4">
                                       <div class="card-body text-center py-8">
                                          <!-- img -->
                                          <a href="#"><img src="theme/assets/images/category/category-instant-food.jpg" alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                          <!-- text -->
                                       </div>
                                    </div>
                                    <div>
	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-8 col-md-12 col-lg-4">
				<a href="#"><img src="https://freshcart.codescandy.com/assets/images/logo/freshcart-white-logo.svg" alt="" /></a>
			</div>
			...
			<div class="row gy-4 align-items-center">
				...
				<div class="col-lg-6 text-end mb-2 mb-lg-0">
					<ul class="list-inline mb-0">
						...
						<li class="list-inline-item">
							<a href="#!"><img src="https://freshcart.codescandy.com/assets/images/payment/amazonpay.svg" alt="" /></a>
						</li>
						<li class="list-inline-item">
							<a href="#!"><img src="https://freshcart.codescandy.com/assets/images/payment/american-express.svg" alt="" /></a>
						</li>
						<li class="list-inline-item">
							<a href="#!"><img src="https://freshcart.codescandy.com/assets/images/payment//mastercard.svg" alt="" /></a>
						</li>
						<li class="list-inline-item">
							<a href="#!"><img src="https://freshcart.codescandy.com/assets/images/payment/paypal.svg" alt="" /></a>
						</li>
						<li class="list-inline-item">
							<a href="#!"><img src="https://freshcart.codescandy.com/assets/images/payment/visa.svg" alt="" /></a>
						</li>
					</ul>
				</div>
			</div>
...
<script src="theme/assets/js/theme.min.js"></script>
      ...
      <script src="theme/assets/js/vendors/jquery.min.js"></script>
      <script src="theme/assets/libs/slick-carousel/slick/slick.min.js"></script>
      <script src="theme/assets/js/vendors/slick-slider.js"></script>
      <script src="theme/assets/libs/tiny-slider/dist/min/tiny-slider.js"></script>
      <script src="theme/assets/js/vendors/tns-slider.js"></script>
      <script src="theme/assets/js/vendors/zoom.js"></script>

      <script src="theme/assets/js/vendors/countdown.js"></script>
      <script src="theme/assets/libs/sticky-sidebar/dist/sticky-sidebar.min.js"></script>
      <script src="theme/assets/js/vendors/sticky.js"></script>
      <script src="theme/assets/js/vendors/modal.js"></script>
   </body>

<!-- Mirrored from freshcart.codescandy.com/pages/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 21 Jul 2024 18:50:19 GMT -->
</html>
