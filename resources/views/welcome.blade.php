...
<head>
    ...
    <link rel="stylesheet" href="web/assets/plugins/css/select2.css">
    <link rel="stylesheet" href="web/css/tailwind.css">
                ...
                <div class="container px-3 md:px-5 xl:px-0">
                    <div class="flex justify-between items-center py-5">
                        ...
                        <div class="lg:max-w-[413px] lg:block hidden w-full">
                            <div class="relative">
                                <input type="text" id="search" name="noautocomplete" autocomplete="false" placeholder="Search a business here...................." class="block w-full bg-white focus:outline-none border-0 px-4 py-3 rounded-lg focus:ring-2 ring-[#029FAE]">
        ...
        <div class="nav-menu" id="nav-menu">
            ...
            <div class="px-3 mb-4">
                <div class="lg:max-w-[413px] w-full">
                    <div class="relative">
                        <input type="text" placeholder="search  a business here............." class="block w-full bg-grayscales-500 focus:outline-none border-0 px-4 py-3 rounded-lg">
            ...
            <div id="panels">
                <div class="panel-1 tab-content active">
                    <ul class="flex flex-col items-center">
                        ...
                        <li class="w-full block">
                            <a href="" class="border-b border-[#029FAE] block px-3 py-2">Get listed</a>
                        </li>
                    </ul>
                </div>
                <div class="panel-2 tab-content py-5">
                    <ul>
                        <li>
                            <a href="#" class="border-b border-[#029FAE] block px-3 py-2">Eletronics</a>
                        </li>
                        <li>
                            <a href="#" class="border-b border-[#029FAE] block px-3 py-2">Hardware</a>
                        </li>
...
>>>>>>> 014fc76498969cc6dd71946cfa5fdc71f96f8ea5
                ...
                <div class="swiper-slide" >
                    <div class="container px-3 md:px-5 flex flex-col md:flex-row items-center" >
                        ...
                        <div class="md:w-1/2 w-full" >
                            ...
                            <h1 class="xl:text-[68px] text-xl md:text-3xl xl:leading-[110%] text-gray-black font-semibold mb-6">List your business and increase brand visibility.</h1>
                            <div>
                        ...
                        <!--<div class="md:w-1/2 w-full flex justify-center items-center relative">
                            <img src="web/images/home2.png" alt=""> 
                        </div>-->
        ...
        <footer>
            ...
            <div class="footer-bottom shadow-[inset_0px_1px_0px_#E1E3E6] py-6">
                <div class="container px-3 md:px-5 xl:px-0">
                  ...
                  __      <p class="text-center text-[#9A9CAA]">@ 2021 - Blogy - Designed & Develop by <b class="text-grayscales-900">Zakirsoft</b></p>
                        <div class="inline-flex justify-center h-[27px] w-[227px]">
                            <img src="web/assets/images/all-img/payments.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- script file here -->
    <script src="web/assets/plugins/js/jquery.js"></script>
    <script src="web/assets/plugins/js/swipper.js"></script>
