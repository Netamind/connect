                        ...
                        <ul class="lg:flex gap-8 items-center hidden main-menu">
                            ...
                            <li class="relative">
                                <a href="javascript:void(0);" class="inline-flex gap-2 items-center">Pages
                                    <span>
                                    <img src="web/assets/images/all-img/select-arrow.png" alt="">     
                                    </span>
                                </a>
                                <ul>
                                    <li>
            ...
            <div class="swiper brandSwiper overflow-hidden">
                <div class="swiper-wrapper items-center">
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="web/assets/images/all-img/brand-logo-01.png" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="web/assets/images/all-img/brand-logo-02.png" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="web/assets/images/all-img/brand-logo-03.png" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="web/assets/images/all-img/brand-logo-04.png" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="web/assets/images/all-img/brand-logo-05.png" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="web/assets/images/all-img/brand-logo-06.png" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="web/assets/images/all-img/brand-logo-07.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
