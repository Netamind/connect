...
<a href="index.html">
<img class="img-fluid" src="dashboard/files/assets/images/logo.png" alt="Theme-Logo" />
</a>
...
<li>
<div class="media">
<img class="d-flex align-self-center img-radius" src="dashboard/files/assets/images/avatar-4.jpg" alt="Generic placeholder image">
...
<li>
<div class="media">
<img class="d-flex align-self-center img-radius" src="dashboard/files/assets/images/avatar-3.jpg" alt="Generic placeholder image">
<div class="media-body">
...
<div class="dropdown-primary dropdown">
<div class="dropdown-toggle" data-toggle="dropdown">
<img src="dashbaord/files/assets/images/avatar-4.jpg" class="img-radius" alt="">
<span>John Doe</span>
...
<img class="media-object img-radius img-radius" src="dashboard/files/assets/images/avatar-3.jpg" alt="Generic placeholder image ">
...
<a class="media-left" href="#!">
<img class="media-object img-radius" src="dashboard/files/assets/images/avatar-2.jpg" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-radius" src="dashboard/files/assets/images/avatar-4.jpg" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-radius" src="dashboard/files/assets/images/avatar-3.jpg" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<img class="media-object img-radius img-radius m-t-5" src="dashboard/files/assets/images/avatar-3.jpg" alt="Generic placeholder image">
</a>
...
<a href="#!">
<img class="media-object img-radius img-radius m-t-5" src="dashboard/files/assets/images/avatar-4.jpg" alt="Generic placeholder image">
</a>
</div>
</div>
...
<a href="app-data">
<span class="pcoded-mtext">App data</span>
</a>
</li>
...
<script type="text/javascript" src="dashboard/files/assets/js/modal.js"></script>
...
<script type="text/javascript" src="dashboard/files/assets/js/modalEffects.js"></script>
